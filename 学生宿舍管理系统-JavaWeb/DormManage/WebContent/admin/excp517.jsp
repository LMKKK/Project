...
<div class="data_list">
    ...
    <form name="myForm" class="form-search" method="post" action="excp?action=search" style="padding-bottom: 0px">
        ...
        <table class="table table-striped table-bordered table-hover datatable">
            ...
            <c:forEach varStatus="i" var="exception" items="${exceptionList }">
                <tr>
                    ...
                    <td><a href="excp?action=show&excpId=${exception.excpId}">查看详情</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
