...
<div class="data_list">
    ...
    <form action="record?exception=save" method="post" onsubmit="return checkForm()">
        <div class="data_form">
            ...
            <table align="center" style="height: 500px;width: 300px">
                ...
                <tr>
                    ...
                    <td><input type="text" value="${exception.state==null?state:exception.state}" readonly></td>
                </tr>
                <tr>
            ...
            <div align="center">
                <%--                <c:if test="${exception.excpId == null}">--%>
